...
class LessonController extends Controller 
{
    ...
    {         
        ...
        $request->validate([             
            ...
            'semester' => 'required|string|in:1st,2nd', // Added semester validation
        ...
        $lesson = $course->lessons()->create([             
            'title' => $request->title,
            'semester' => $request->semester, // Saves the semester to the database
    ...
    {         
        ...
        $request->validate([
            'title' => 'required|string|max:255', 
            'semester' => 'required|string|in:1st,2nd', // Validates the semester choice[cite: 6]
            'available_from' => 'required|date', 
            'available_until' => 'required|date|after_or_equal:available_from'
        ]);         
        
        // Explicitly saves the semester choice to the database[cite: 6]
